...
echo "deb [arch=$(dpkg --print-architecture) signed-by=/etc/apt/keyrings/grafana.gpg] https://apt.grafana.com/pool/main/g/grafana-agent-flow $(lsb_release -cs) stable main" | tee -i /etc/apt/sources.list.d/grafana.list
